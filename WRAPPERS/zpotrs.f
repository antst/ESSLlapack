...
*  ==== ========== ========
*
*  This is a stub routine that calls the ESSL subroutine ZPOSM.  In all
*  cases, the results returned will be identical in structure to those
*  of the normal LAPACK routine ZPOTRS.
*
*  Arguments
*  =========
*
...
*
     ...
     $   RETURN
*
      CALL ESSL_ZPOTRS( UPLO, N, NRHS, A, LDA, B, LDB, INFO )
*
      RETURN
*
*     End of ZPOTRS
