...
*  ==== ========== ========
*
*  This is a stub routine that calls the ESSL subroutine ZPOF.  In all
*  cases, the results returned will be identical in structure to those
*  of the normal LAPACK routine ZPOTRF.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           EINFO, ERRSAV, ERRSET, ERRSTR, XERBLA, ZPOF
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
     ...
     $   RETURN
*
      CALL ESSL_ZPOTRF( UPLO, N, A, LDA, INFO )
*
      RETURN
*
*     End of ZPOTRF
