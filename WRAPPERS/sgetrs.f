...
*  ==== ========== ========
*
*  This is a stub routine that calls the ESSL subroutine SGESM.
*  In all cases, the results returned will be identical in structure
*  to those of the normal LAPACK routine SGETRS.
*
*  Arguments
*  =========
*
...
*
     ...
     $   RETURN
      CALL ESSL_SGETRS( TRANS, N, NRHS, A, LDA, IPIV, B, LDB, INFO )
*
      RETURN
*
*     End of SGETRS
