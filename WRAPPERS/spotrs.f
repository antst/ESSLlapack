...
*  ==== ========== ========
*
*  This is a stub routine that calls the ESSL subroutine SPOSM.  In all 
*  cases, the results returned will be identical in structure to those
*  of the normal LAPACK routine SPOTRS.
*
*  Arguments
*  =========
*
...
*
     ...
     $   RETURN
*
      CALL ESSL_SPOTRS( UPLO, N, NRHS, A, LDA, B, LDB, INFO )
*
      RETURN
*
*     End of SPOTRS
