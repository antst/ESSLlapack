...
*  ==== ========== ========
*
*  This is a stub routine that calls the ESSL subroutine DPOSM.  In all
*  cases, the results returned will be identical in structure to those
*  of the normal LAPACK routine DPOTRS.
*
*  Arguments
*  =========
*
...
*
     ...
     $   RETURN
*
      CALL ESSL_DPOTRS( UPLO, N, NRHS, A, LDA, B, LDB, INFO )
*
      RETURN
*
*     End of DPOTRS
