...
*  ==== ========== ========
*
*  This is a stub routine that calls the ESSL subroutine DTRI.  In all
*  cases, the results returned will be identical in structure to those
*  of the normal LAPACK routine DTRTRI.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           DTRI, EINFO, ERRSAV, ERRSET, ERRSTR, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
     ...
     $   RETURN
*
      CALL ESSL_DTRTRI( UPLO, DIAG, N, A, LDA, INFO )
*
      RETURN
*
*     End of DTRTRI
