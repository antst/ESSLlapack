...
*  ==== ========== ========
*
*  This is a stub routine that calls the ESSL subroutine CPOF.  In all
*  cases, the results returned will be identical in structure to those
*  of the normal LAPACK routine CPOTRF.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           CPOF, EINFO, ERRSAV, ERRSET, ERRSTR, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
     ...
     $   RETURN
*
      CALL ESSL_ CPOTRF( UPLO, N, A, LDA, INFO )
*
      RETURN
*
*     End of CPOTRF
