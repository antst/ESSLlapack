...
*  ==== ========== ========
*
*  This is a stub routine that calls the ESSL subroutine DPOF.  In all
*  cases, the results returned will be identical in structure to those
*  of the normal LAPACK routine DPOTRF.
*
*  Arguments
*  =========
*
...
*     .. External Subroutines ..
      EXTERNAL           DPOF, EINFO, ERRSAV, ERRSET, ERRSTR, XERBLA
*     ..
*     .. Intrinsic Functions ..
      INTRINSIC          MAX
*     ..
...
*
     ...
     $   RETURN
*
      CALL ESSL_DPOTRF( UPLO, N, A, LDA, INFO )
*
      RETURN
*
*     End of DPOTRF
