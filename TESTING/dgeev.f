...
*
         ...
         CALL ERRSAV( 2101, SV2101 )
	 
         CALL ERRSET( 2101, 256, -1, 0, 0, 2101 )
	 
         CALL ESSL_DGEEV(IOPT,A,LDA,WORK(IOFS+1),VR,LDVR,SELECT,0,N,WORK,IOFS)
	 WR=REAL(WORK(IOFS+1:IOFS+N),KIND=8)
	 WI=IMAG(WORK(IOFS+1+N:IOFS+2*N),KIND=8)	 
*         Error handling should be here!
         CALL EINFO( 2101, IERR1, IERR2 )
	 IF (IERR1.GT.0) THEN
	    INFO=IERR1
	 END IF

	 CALL ERRSTR( 2101, SV2101 )
